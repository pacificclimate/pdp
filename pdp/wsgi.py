...
frontend = initialize_frontend(global_config, use_analytics=global_config['use_analytics'])
backend = initialize_backend(global_config, use_analytics=global_config['use_analytics'])
