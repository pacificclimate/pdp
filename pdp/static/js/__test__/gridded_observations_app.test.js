...
require('./globals-helpers').importGlobals([
    ...
    // Note: mocking!
    { module: 'js/__mocks__/data-services/gridded_observations_app.js', name: 'dataServices' },
    ...
    { module: 'js/gridded_observations_map.js', spread: true },
    { module: 'js/gridded_observations_controls.js', spread: true },
    { module: 'js/gridded_observations_app.js', name: 'gridded_observations_app' },
...
dateFilterTests(gridded_observations_app, {
    cfTimeSystem: {
