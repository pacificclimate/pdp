...
/*
 * This front end displays the CanESM2 MBCn data.
 *    backend: mbcn_canesm5.py
 *    url_base: downscaled_canesm5_multi
 *    ensemble: mbcn_canesm5
 *    map: canada_ex_map.js
 * This portal is identical to the CMIP6 MBCn portal, except for the
...
(function ($) {
    ...
    function canesm5_mbcn_app() {
        ...
        map = init_raster_map({
            variable: "tasmin",
            dataset: "tasmin_day_MBCn_CanESM5_historical-ssp126_r1iippff_19500101-21001231_Canada",
    ...
    condExport(module, canesm5_mbcn_app, 'canesm5_mbcn_app');

    $(document).ready(canesm5_mbcn_app);
})(jQuery);
