...
/*global $, jQuery, OpenLayers, pdp, map, getTimeSelected, ncwmsCapabilities, getRasterNativeProj, getRasterBbox, rasterBBoxToIndicies, intersection*/
...
function download(extension, map, selection_layer, ncwms_layer, dl_type) {
    ...
    raster_proj = getRasterNativeProj(window.ncwmsCapabilities, current_dataset);
    raster_bnds = getRasterBbox(window.ncwmsCapabilities, current_dataset);
