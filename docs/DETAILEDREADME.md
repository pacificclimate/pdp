...
1.0 [Dependencies](#dependencies)
   1.1 [Python](#)
   1.2 [Node.js (test framework only)](#node.js-(test-framework-only))
2.0 [Installation](#installation)
   2.1 [Development](#development)
      2.1.1 [Server](#server)
      2.1.2 [JS tests](#js-tests)
   2.2 [Production](#production)
3.0 [Configuration](#configuration)
   3.1 [Environment variables](#environment-variables)
      3.1.1 [Config Items](#config-items)
   3.2 [JavaScript configuration code](#javascript-configuration-code)
4.0 [Tests](#tests)
   4.1 [Python](#python)
   4.2 [Node.js (tests of JS code)](#node.js-(tests-of-js-code))
5.0 [Deploying](#deploying)
   5.1 [Development](#development)
   5.2 [Production](#production)
      5.2.1 [Gunicorn](#gunicorn)
      5.2.2 [Supervisord](#supervisord)
6.0 [Module `calendars`](#module-calendars)
   6.1 [Introductory notes](#introductory-notes)
   6.2 [Calendars](#calendars)
   6.3 [Datetimes (in specific calendars)](#datetimes-(in-specific-calendars))
   6.4 [CF time systems](#cf-time-systems)
   6.5 [Usage](#usage)
      6.5.1 [`CalendarDatetime`: Datetimes in various calendars](#calendardatetime:-datetimes-in-various-calendars)
      6.5.2 [`CfTimeSystem`: CF time systems](#cftimesystem:-cf-time-systems)
      6.5.3 [`CfDatetime`: CF time points](#cfdatetime:-cf-time-points)
